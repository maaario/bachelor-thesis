...
\newpage 
\chapter*{Abstract}
From the DNA sequencing data a histogram of the number of occurences of substrings of 
a fixed length may be produced. Such histograms can be used to estimate the size of a genome. 
...
we evaluate the precision of such estimates.
